  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="font-heading text-3xl font-bold text-[var(--color-text-primary)]">Projects</h1>
      ...
      <div className="space-y-4">
        ...
        {projects.length === 0 && (
          <GlassCard className="p-12 text-center">
            <p className="text-[var(--color-text-muted)]">No projects yet. Add your first project!</p>
          </GlassCard>
        )}
      </div>
    </div>
